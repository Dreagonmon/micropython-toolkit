...
'''
from bmfont import get_text_line
from hal_screen import get_format # function return int, framebuf.MONO_VLSB etc.
from graphic.framebuf_helper import get_white_color # framebuf.MONO_VLSB return 1, framebuf.COLOR_565 return 65535
