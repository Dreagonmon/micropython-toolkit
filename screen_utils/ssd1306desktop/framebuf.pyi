...
class FrameBuffer(object):
    ...
    def rect(self, x: int, y: int, w: int, h: int, c: Color, f: Optional[bool] = ...) -> None: ...
    def ellipse(self, x: int, y: int, xr: int, yr: int, c: Color, f: Optional[bool] = ..., m: Optional[int] = ...) -> None: ...
    def poly(self, x: int, y: int, coords: array, c: Color, f: Optional[bool] = ...) -> None: ...
